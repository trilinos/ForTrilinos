...
module fortrilinos
 ...
 interface
  ...
  subroutine swigc_TrilinosHandle_init__SWIG_0(farg1, farg2) &
     bind(C, name="swigc_TrilinosHandle_init__SWIG_0")
   use, intrinsic :: ISO_C_BINDING
   type(C_PTR), value :: farg1
   integer(C_INT), intent(in) :: farg2
  end subroutine
  subroutine swigc_TrilinosHandle_init__SWIG_1(farg1) &
...
contains
  ...
  subroutine swigf_TrilinosHandle_init__SWIG_0(self, comm)
   use, intrinsic :: ISO_C_BINDING
   class(TrilinosHandle) :: self
   integer(C_INT), intent(in) :: comm
   call swigc_TrilinosHandle_init__SWIG_0(self%ptr, comm)
  end subroutine
  subroutine swigf_TrilinosHandle_init__SWIG_1(self)
   use, intrinsic :: ISO_C_BINDING
   class(TrilinosHandle) :: self
   call swigc_TrilinosHandle_init__SWIG_1(self%ptr)
  end subroutine
