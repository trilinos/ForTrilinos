...
SWIGEXPORT SwigClassWrapper _wrap_new_TpetraMap__SWIG_0(long const *farg1, SwigClassWrapper const *farg3, int const *farg4, SwigClassWrapper const *farg5) {
  SwigClassWrapper fresult ;
  Tpetra::global_size_t arg1 ;
  long long arg2 ;
  Teuchos::RCP< Teuchos::Comm< int > const > *arg3 = 0 ;
  Tpetra::LocalGlobal arg4 ;
  Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > *arg5 = 0 ;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &,Tpetra::LocalGlobal,Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)");;
    try
    {
      // Attempt the wrapped function call
      result = (Tpetra::Map< LO,GO,NO > *)new Tpetra::Map< LO,GO,NO >(arg1,arg2,(Teuchos::RCP< Teuchos::Comm< int > const > const &)*arg3,arg4,(Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)*arg5);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &,Tpetra::LocalGlobal,Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)", SWIG_IndexError, e.what(), return SwigClassWrapper_uninitialized());
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &,Tpetra::LocalGlobal,Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)", SWIG_RuntimeError, e.what(), return SwigClassWrapper_uninitialized());
    }
    catch (...)
    {
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &,Tpetra::LocalGlobal,Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)", SWIG_UnknownError, "An unknown exception occurred", return SwigClassWrapper_uninitialized());
    }
  }
...
SWIGEXPORT SwigClassWrapper _wrap_new_TpetraMap__SWIG_1(long const *farg1, SwigClassWrapper const *farg3, int const *farg4) {
  SwigClassWrapper fresult ;
  Tpetra::global_size_t arg1 ;
  long long arg2 ;
  Teuchos::RCP< Teuchos::Comm< int > const > *arg3 = 0 ;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &,Tpetra::LocalGlobal)");;
    try
    {
      // Attempt the wrapped function call
    ...
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &,Tpetra::LocalGlobal)", SWIG_IndexError, e.what(), return SwigClassWrapper_uninitialized());
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &,Tpetra::LocalGlobal)", SWIG_RuntimeError, e.what(), return SwigClassWrapper_uninitialized());
    }
    catch (...)
    {
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &,Tpetra::LocalGlobal)", SWIG_UnknownError, "An unknown exception occurred", return SwigClassWrapper_uninitialized());
    }
  }
  fresult.cptr = result ? new Teuchos::RCP< Tpetra::Map<LO,GO,NO> >(result SWIG_NO_NULL_DELETER_1) : NULL;
  fresult.mem = SWIG_MOVE;
...
SWIGEXPORT SwigClassWrapper _wrap_new_TpetraMap__SWIG_2(long const *farg1, SwigClassWrapper const *farg3) {
  SwigClassWrapper fresult ;
  Tpetra::global_size_t arg1 ;
  long long arg2 ;
  Teuchos::RCP< Teuchos::Comm< int > const > *arg3 = 0 ;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &)");;
    try
    {
      // Attempt the wrapped function call
    ...
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &)", SWIG_IndexError, e.what(), return SwigClassWrapper_uninitialized());
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &)", SWIG_RuntimeError, e.what(), return SwigClassWrapper_uninitialized());
    }
    catch (...)
    {
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &)", SWIG_UnknownError, "An unknown exception occurred", return SwigClassWrapper_uninitialized());
    }
  }
  fresult.cptr = result ? new Teuchos::RCP< Tpetra::Map<LO,GO,NO> >(result SWIG_NO_NULL_DELETER_1) : NULL;
  fresult.mem = SWIG_MOVE;
...
SWIGEXPORT SwigClassWrapper _wrap_new_TpetraMap__SWIG_3(long const *farg1, int const *farg2, SwigClassWrapper const *farg4, SwigClassWrapper const *farg5) {
  SwigClassWrapper fresult ;
  Tpetra::global_size_t arg1 ;
  size_t arg2 ;
  long long arg3 ;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &,Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)");;
    try
    {
      // Attempt the wrapped function call
      result = (Tpetra::Map< LO,GO,NO > *)new Tpetra::Map< LO,GO,NO >(arg1,arg2,arg3,(Teuchos::RCP< Teuchos::Comm< int > const > const &)*arg4,(Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)*arg5);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &,Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)", SWIG_IndexError, e.what(), return SwigClassWrapper_uninitialized());
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &,Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)", SWIG_RuntimeError, e.what(), return SwigClassWrapper_uninitialized());
    }
    catch (...)
    {
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &,Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)", SWIG_UnknownError, "An unknown exception occurred", return SwigClassWrapper_uninitialized());
    }
  }
  fresult.cptr = result ? new Teuchos::RCP< Tpetra::Map<LO,GO,NO> >(result SWIG_NO_NULL_DELETER_1) : NULL;
  fresult.mem = SWIG_MOVE;
...
SWIGEXPORT SwigClassWrapper _wrap_new_TpetraMap__SWIG_4(long const *farg1, int const *farg2, SwigClassWrapper const *farg4) {
  SwigClassWrapper fresult ;
  Tpetra::global_size_t arg1 ;
  size_t arg2 ;
  long long arg3 ;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &)");;
    try
    {
      // Attempt the wrapped function call
    ...
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &)", SWIG_IndexError, e.what(), return SwigClassWrapper_uninitialized());
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &)", SWIG_RuntimeError, e.what(), return SwigClassWrapper_uninitialized());
    }
    catch (...)
    {
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t,size_t,long long,Teuchos::RCP< Teuchos::Comm< int > const > const &)", SWIG_UnknownError, "An unknown exception occurred", return SwigClassWrapper_uninitialized());
    }
  }
  fresult.cptr = result ? new Teuchos::RCP< Tpetra::Map<LO,GO,NO> >(result SWIG_NO_NULL_DELETER_1) : NULL;
  fresult.mem = SWIG_MOVE;
...
SWIGEXPORT SwigClassWrapper _wrap_new_TpetraMap__SWIG_5(long const *farg1, SwigArrayWrapper *farg2, SwigClassWrapper const *farg4, SwigClassWrapper const *farg5) {
  SwigClassWrapper fresult ;
  Tpetra::global_size_t arg1 ;
  ...
  Teuchos::RCP< Teuchos::Comm< int > const > *arg4 = 0 ;
  Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > *arg5 = 0 ;
  Teuchos::ArrayView< long long const > tmparr2 ;
  Teuchos::RCP< Teuchos::Comm< int > const > tempnull4 ;
  Tpetra::Map< LO,GO,NO > *result = 0 ;
  ...
  arg1 = static_cast< Tpetra::global_size_t >(*farg1);
  tmparr2 = Teuchos::ArrayView<long long const>(static_cast<long long const*>(farg2->data), farg2->size);
  arg2 = &tmparr2;
  arg4 = farg4->cptr ? static_cast< Teuchos::RCP< Teuchos::Comm< int > const > * >(farg4->cptr) : &tempnull4;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t const,Teuchos::ArrayView< long long const > const &,long long const,Teuchos::RCP< Teuchos::Comm< int > const > const &,Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)");;
    try
    {
      // Attempt the wrapped function call
      result = (Tpetra::Map< LO,GO,NO > *)new Tpetra::Map< LO,GO,NO >(arg1,(Teuchos::ArrayView< long long const > const &)*arg2,arg3,(Teuchos::RCP< Teuchos::Comm< int > const > const &)*arg4,(Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)*arg5);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t const,Teuchos::ArrayView< long long const > const &,long long const,Teuchos::RCP< Teuchos::Comm< int > const > const &,Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)", SWIG_IndexError, e.what(), return SwigClassWrapper_uninitialized());
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::Map< LO,GO,NO >::Map(Tpetra::global_size_t const,Teuchos::ArrayView< long long const > const &,long long const,Teuchos::RCP< Teuchos::Comm< int > const > const &,Teuchos::RCP< Kokkos::Compat::KokkosSerialWrapperNode > const &)", SWIG_RuntimeError, e.what(), return SwigClassWrapper_uninitialized());
    }
    catch (...)
    {
...
SWIGEXPORT SwigClassWrapper _wrap_new_TpetraMap__SWIG_6(long const *farg1, SwigArrayWrapper *farg2, SwigClassWrapper const *farg4) {
  SwigClassWrapper fresult ;
  Tpetra::global_size_t arg1 ;
  Teuchos::ArrayView< long long const > *arg2 = 0 ;
  long long arg3 ;
...
SWIGEXPORT SwigClassWrapper _wrap_new_TpetraMap__SWIG_7() {
  SwigClassWrapper fresult ;
  Tpetra::Map< LO,GO,NO > *result = 0 ;
...
SWIGEXPORT int _wrap_TpetraMap_getRemoteIndexList__SWIG_0(SwigClassWrapper const *farg1, SwigArrayWrapper *farg2, SwigArrayWrapper *farg3, SwigArrayWrapper *farg4) {
  ...
  Teuchos::RCP< Tpetra::Map< LO,GO,NO > const > *smartarg1 ;
  Teuchos::ArrayView< long long const > tmparr2 ;
  Teuchos::ArrayView< int > tmparr3 ;
  Teuchos::ArrayView< int > tmparr4 ;
  ...
  tmparr2 = Teuchos::ArrayView<long long const>(static_cast<long long const*>(farg2->data), farg2->size);
  arg2 = &tmparr2;
  tmparr3 = Teuchos::ArrayView<int>(static_cast<int*>(farg3->data), farg3->size);
  arg3 = &tmparr3;
  tmparr4 = Teuchos::ArrayView<int>(static_cast<int*>(farg4->data), farg4->size);
  arg4 = &tmparr4;
  {
    // Make sure no unhandled exceptions exist before performing a new action
...
SWIGEXPORT void _wrap_TpetraImport_setParameterList(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2) {
  Tpetra::Import< LO,GO,NO > *arg1 = (Tpetra::Import< LO,GO,NO > *) 0 ;
...
SWIGEXPORT void _wrap_TpetraExport_setParameterList(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2) {
  Tpetra::Export< LO,GO,NO > *arg1 = (Tpetra::Export< LO,GO,NO > *) 0 ;
  Teuchos::RCP< Teuchos::ParameterList > *arg2 = 0 ;
  Teuchos::RCP< Tpetra::Export< LO,GO,NO > > *smartarg1 ;
  Teuchos::RCP< Teuchos::ParameterList > tempnull2 ;
...
SWIGEXPORT SwigClassWrapper _wrap_new_TpetraMultiVector__SWIG_3(SwigClassWrapper const *farg1) {
  SwigClassWrapper fresult ;
...
SWIGEXPORT SwigClassWrapper _wrap_new_TpetraMultiVector__SWIG_4(SwigClassWrapper const *farg1, int const *farg2) {
  SwigClassWrapper fresult ;
  Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode > *arg1 = 0 ;
...
SWIGEXPORT SwigClassWrapper _wrap_new_TpetraMultiVector__SWIG_5(SwigClassWrapper const *farg1, SwigArrayWrapper *farg2, size_t const *farg3, size_t const *farg4) {
  SwigClassWrapper fresult ;
  Teuchos::RCP< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::map_type const > *arg1 = 0 ;
  ...
  size_t arg4 ;
  Teuchos::RCP< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::map_type const > tempnull1 ;
  Teuchos::ArrayView< double const > tmparr2 ;
  Tpetra::MultiVector< SC,LO,GO,NO > *result = 0 ;
  
  arg1 = farg1->cptr ? static_cast< Teuchos::RCP< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::map_type const > * >(farg1->cptr) : &tempnull1;
  tmparr2 = Teuchos::ArrayView<double const>(static_cast<double const*>(farg2->data), farg2->size);
  arg2 = &tmparr2;
...
SWIGEXPORT SwigClassWrapper _wrap_new_TpetraMultiVector__SWIG_7(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2, size_t const *farg3) {
  SwigClassWrapper fresult ;
  Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode > *arg1 = 0 ;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::MultiVector(Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode > const &,Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::map_type const &,size_t const)");;
    try
    {
      // Attempt the wrapped function call
      result = (Tpetra::MultiVector< SC,LO,GO,NO > *)new Tpetra::MultiVector< SC,LO,GO,NO >((Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode > const &)*arg1,(Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::map_type const &)*arg2,arg3);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
...
SWIGEXPORT SwigClassWrapper _wrap_new_TpetraMultiVector__SWIG_8(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2) {
  SwigClassWrapper fresult ;
  Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode > *arg1 = 0 ;
  Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::map_type *arg2 = 0 ;
  Teuchos::RCP< Tpetra::MultiVector< SC,LO,GO,NO > const > *smartarg1 ;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::MultiVector(Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode > const &,Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::map_type const &)");;
    try
    {
      // Attempt the wrapped function call
      result = (Tpetra::MultiVector< SC,LO,GO,NO > *)new Tpetra::MultiVector< SC,LO,GO,NO >((Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode > const &)*arg1,(Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::map_type const &)*arg2);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::MultiVector(Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode > const &,Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::map_type const &)", SWIG_IndexError, e.what(), return SwigClassWrapper_uninitialized());
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
...
SWIGEXPORT void _wrap_TpetraMultiVector_get1dCopy(SwigClassWrapper const *farg1, SwigArrayWrapper *farg2, size_t const *farg3) {
  ...
  size_t arg3 ;
  Teuchos::RCP< Tpetra::MultiVector< SC,LO,GO,NO > const > *smartarg1 ;
  Teuchos::ArrayView< double > tmparr2 ;
  
  smartarg1 = static_cast< Teuchos::RCP<const Tpetra::MultiVector<SC,LO,GO,NO> >* >(farg1->cptr);
  arg1 = smartarg1 ? const_cast< Tpetra::MultiVector<SC,LO,GO,NO>* >(smartarg1->get()) : NULL;
  tmparr2 = Teuchos::ArrayView<double>(static_cast<double*>(farg2->data), farg2->size);
  arg2 = &tmparr2;
  arg3 = static_cast< size_t >(*farg3);
  {
    // Make sure no unhandled exceptions exist before performing a new action
...
SWIGEXPORT void _wrap_TpetraMultiVector_dot__SWIG_0(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2, SwigArrayWrapper *farg3) {
  ...
  Teuchos::ArrayView< double > tmparr3 ;
  ...
  arg2 = const_cast< Tpetra::MultiVector<SC,LO,GO,NO>* >(smartarg2->get());
  tmparr3 = Teuchos::ArrayView<double>(static_cast<double*>(farg3->data), farg3->size);
  arg3 = &tmparr3;
  {
    // Make sure no unhandled exceptions exist before performing a new action
...
SWIGEXPORT void _wrap_TpetraMultiVector_dot__SWIG_3(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2, SwigClassWrapper const *farg3) {
  Tpetra::MultiVector< SC,LO,GO,NO > *arg1 = (Tpetra::MultiVector< SC,LO,GO,NO > *) 0 ;
  Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode > *arg2 = 0 ;
  Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::dot_type *,Kokkos::HostSpace > *arg3 = 0 ;
  Teuchos::RCP< Tpetra::MultiVector< SC,LO,GO,NO > const > *smartarg1 ;
  Teuchos::RCP< Tpetra::MultiVector< SC,LO,GO,NO > const > *smartarg2 ;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::dot(Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode > const &,Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::dot_type *,Kokkos::HostSpace > const &) const");;
    try
    {
      // Attempt the wrapped function call
      ((Tpetra::MultiVector< SC,LO,GO,NO > const *)arg1)->dot((Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode > const &)*arg2,(Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::dot_type *,Kokkos::HostSpace > const &)*arg3);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::dot(Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode > const &,Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::dot_type *,Kokkos::HostSpace > const &) const", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::dot(Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode > const &,Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::dot_type *,Kokkos::HostSpace > const &) const", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
...
SWIGEXPORT void _wrap_TpetraMultiVector_norm1__SWIG_1(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2) {
  Tpetra::MultiVector< SC,LO,GO,NO > *arg1 = (Tpetra::MultiVector< SC,LO,GO,NO > *) 0 ;
  Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > *arg2 = 0 ;
  Teuchos::RCP< Tpetra::MultiVector< SC,LO,GO,NO > const > *smartarg1 ;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::norm1(Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > const &) const");;
    try
    {
      // Attempt the wrapped function call
      ((Tpetra::MultiVector< SC,LO,GO,NO > const *)arg1)->norm1((Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > const &)*arg2);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::norm1(Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > const &) const", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::norm1(Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > const &) const", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
...
SWIGEXPORT void _wrap_TpetraMultiVector_norm2__SWIG_1(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2) {
  Tpetra::MultiVector< SC,LO,GO,NO > *arg1 = (Tpetra::MultiVector< SC,LO,GO,NO > *) 0 ;
  Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > *arg2 = 0 ;
  Teuchos::RCP< Tpetra::MultiVector< SC,LO,GO,NO > const > *smartarg1 ;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::norm2(Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > const &) const");;
    try
    {
      // Attempt the wrapped function call
      ((Tpetra::MultiVector< SC,LO,GO,NO > const *)arg1)->norm2((Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > const &)*arg2);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::norm2(Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > const &) const", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::norm2(Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > const &) const", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
...
SWIGEXPORT void _wrap_TpetraMultiVector_normInf__SWIG_1(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2) {
  Tpetra::MultiVector< SC,LO,GO,NO > *arg1 = (Tpetra::MultiVector< SC,LO,GO,NO > *) 0 ;
  Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > *arg2 = 0 ;
  Teuchos::RCP< Tpetra::MultiVector< SC,LO,GO,NO > const > *smartarg1 ;
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::normInf(Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > const &) const");;
    try
    {
      // Attempt the wrapped function call
      ((Tpetra::MultiVector< SC,LO,GO,NO > const *)arg1)->normInf((Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > const &)*arg2);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::normInf(Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > const &) const", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::MultiVector< SC,LO,GO,NO >::normInf(Kokkos::View< Tpetra::MultiVector< double,int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::mag_type *,Kokkos::HostSpace > const &) const", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
...
SWIGEXPORT void _wrap_TpetraCrsGraph_swap(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2) {
  Tpetra::CrsGraph< LO,GO,NO > *arg1 = (Tpetra::CrsGraph< LO,GO,NO > *) 0 ;
  ...
  smartarg1 = static_cast< Teuchos::RCP< Tpetra::CrsGraph<LO,GO,NO> >* >(farg1->cptr);
  arg1 = smartarg1 ? const_cast< Tpetra::CrsGraph<LO,GO,NO>* >(smartarg1->get()) : NULL;
  SWIG_check_sp_nonnull(farg2, "Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode > *", "TpetraCrsGraph", "Tpetra::CrsGraph< LO,GO,NO >::swap(Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode > &)", return )
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::swap(Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode > &)");;
    try
    {
      // Attempt the wrapped function call
      (arg1)->swap(*arg2);
    ...
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::swap(Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode > &)", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::swap(Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode > &)", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
...
SWIGEXPORT void _wrap_TpetraCrsGraph_insertGlobalIndices__SWIG_0(SwigClassWrapper const *farg1, long long const *farg2, SwigArrayWrapper *farg3) {
  ...
  Teuchos::RCP< Tpetra::CrsGraph< LO,GO,NO > > *smartarg1 ;
  Teuchos::ArrayView< long long const > tmparr3 ;
  
  smartarg1 = static_cast< Teuchos::RCP< Tpetra::CrsGraph<LO,GO,NO> >* >(farg1->cptr);
  arg1 = smartarg1 ? const_cast< Tpetra::CrsGraph<LO,GO,NO>* >(smartarg1->get()) : NULL;
  arg2 = static_cast< long long >(*farg2);
  tmparr3 = Teuchos::ArrayView<long long const>(static_cast<long long const*>(farg3->data), farg3->size);
  arg3 = &tmparr3;
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::insertGlobalIndices(long long const,Teuchos::ArrayView< long long const > const &)");;
    try
    {
      // Attempt the wrapped function call
    ...
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::insertGlobalIndices(long long const,Teuchos::ArrayView< long long const > const &)", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::insertGlobalIndices(long long const,Teuchos::ArrayView< long long const > const &)", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
...
SWIGEXPORT void _wrap_TpetraCrsGraph_insertLocalIndices(SwigClassWrapper const *farg1, int const *farg2, SwigArrayWrapper *farg3) {
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::insertLocalIndices(int const,Teuchos::ArrayView< int const > const &)");;
    try
    {
      // Attempt the wrapped function call
    ...
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::insertLocalIndices(int const,Teuchos::ArrayView< int const > const &)", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::insertLocalIndices(int const,Teuchos::ArrayView< int const > const &)", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
...
SWIGEXPORT void _wrap_TpetraCrsGraph_getGlobalRowCopy(SwigClassWrapper const *farg1, long long const *farg2, SwigArrayWrapper *farg3, size_t *farg4) {
  ...
  size_t *arg4 = 0 ;
  Teuchos::RCP< Tpetra::CrsGraph< LO,GO,NO > const > *smartarg1 ;
  Teuchos::ArrayView< long long > tmparr3 ;
  
  smartarg1 = static_cast< Teuchos::RCP<const Tpetra::CrsGraph<LO,GO,NO> >* >(farg1->cptr);
  arg1 = smartarg1 ? const_cast< Tpetra::CrsGraph<LO,GO,NO>* >(smartarg1->get()) : NULL;
  arg2 = static_cast< long long >(*farg2);
  tmparr3 = Teuchos::ArrayView<long long>(static_cast<long long*>(farg3->data), farg3->size);
  arg3 = &tmparr3;
  arg4 = reinterpret_cast< size_t * >(farg4);
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::getGlobalRowCopy(long long,Teuchos::ArrayView< long long > const &,size_t &) const");;
    try
    {
      // Attempt the wrapped function call
      ((Tpetra::CrsGraph< LO,GO,NO > const *)arg1)->getGlobalRowCopy(arg2,(Teuchos::ArrayView< long long > const &)*arg3,*arg4);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::getGlobalRowCopy(long long,Teuchos::ArrayView< long long > const &,size_t &) const", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::getGlobalRowCopy(long long,Teuchos::ArrayView< long long > const &,size_t &) const", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
...
SWIGEXPORT void _wrap_TpetraCrsGraph_getLocalRowCopy(SwigClassWrapper const *farg1, int const *farg2, SwigArrayWrapper *farg3, size_t *farg4) {
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::getLocalRowCopy(int,Teuchos::ArrayView< int > const &,size_t &) const");;
    try
    {
      // Attempt the wrapped function call
      ((Tpetra::CrsGraph< LO,GO,NO > const *)arg1)->getLocalRowCopy(arg2,(Teuchos::ArrayView< int > const &)*arg3,*arg4);
    }
    catch (const std::range_error& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::getLocalRowCopy(int,Teuchos::ArrayView< int > const &,size_t &) const", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::getLocalRowCopy(int,Teuchos::ArrayView< int > const &,size_t &) const", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
...
SWIGEXPORT void _wrap_TpetraCrsGraph_importAndFillComplete__SWIG_0(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2, SwigClassWrapper const *farg3, SwigClassWrapper const *farg4, SwigClassWrapper const *farg5, SwigClassWrapper const *farg6) {
  Tpetra::CrsGraph< LO,GO,NO > *arg1 = (Tpetra::CrsGraph< LO,GO,NO > *) 0 ;
  Teuchos::RCP< Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode > > *arg2 = 0 ;
  ...
  Teuchos::RCP< Teuchos::ParameterList > *arg6 = 0 ;
  Teuchos::RCP< Tpetra::CrsGraph< LO,GO,NO > const > *smartarg1 ;
  Teuchos::RCP< Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode > > tempnull2 ;
  Teuchos::RCP< Tpetra::Import< LO,GO,NO > const > *smartarg3 ;
  ...
  smartarg1 = static_cast< Teuchos::RCP<const Tpetra::CrsGraph<LO,GO,NO> >* >(farg1->cptr);
  arg1 = smartarg1 ? const_cast< Tpetra::CrsGraph<LO,GO,NO>* >(smartarg1->get()) : NULL;
  arg2 = farg2->cptr ? static_cast< Teuchos::RCP< Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode > > * >(farg2->cptr) : &tempnull2;
...
SWIGEXPORT void _wrap_TpetraCrsGraph_exportAndFillComplete__SWIG_3(SwigClassWrapper const *farg1, SwigClassWrapper const *farg2, SwigClassWrapper const *farg3) {
  ...
  {
    // Make sure no unhandled exceptions exist before performing a new action
    SWIG_check_unhandled_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::exportAndFillComplete(Teuchos::RCP< Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode > > &,Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::export_type const &) const");;
    try
    {
      // Attempt the wrapped function call
    ...
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::exportAndFillComplete(Teuchos::RCP< Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode > > &,Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::export_type const &) const", SWIG_IndexError, e.what(), return );
    }
    catch (const std::exception& e)
    {
      // Store a C++ exception
      SWIG_exception_impl("Tpetra::CrsGraph< LO,GO,NO >::exportAndFillComplete(Teuchos::RCP< Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode > > &,Tpetra::CrsGraph< int,long long,Kokkos::Compat::KokkosSerialWrapperNode >::export_type const &) const", SWIG_RuntimeError, e.what(), return );
    }
    catch (...)
    {
...
SWIGEXPORT void _wrap_TpetraCrsMatrix_insertGlobalValues(SwigClassWrapper const *farg1, long long const *farg2, SwigArrayWrapper *farg3, SwigArrayWrapper *farg4) {
  ...
  Teuchos::RCP< Tpetra::CrsMatrix< SC,LO,GO,NO > > *smartarg1 ;
  Teuchos::ArrayView< long long const > tmparr3 ;
  Teuchos::ArrayView< double const > tmparr4 ;
  ...
  tmparr3 = Teuchos::ArrayView<long long const>(static_cast<long long const*>(farg3->data), farg3->size);
  arg3 = &tmparr3;
  tmparr4 = Teuchos::ArrayView<double const>(static_cast<double const*>(farg4->data), farg4->size);
  arg4 = &tmparr4;
  {
    // Make sure no unhandled exceptions exist before performing a new action
...
SWIGEXPORT void _wrap_TpetraCrsMatrix_getGlobalRowCopy(SwigClassWrapper const *farg1, long long const *farg2, SwigArrayWrapper *farg3, SwigArrayWrapper *farg4, size_t *farg5) {
  ...
  Teuchos::RCP< Tpetra::CrsMatrix< SC,LO,GO,NO > const > *smartarg1 ;
  Teuchos::ArrayView< long long > tmparr3 ;
  Teuchos::ArrayView< double > tmparr4 ;
  ...
  tmparr3 = Teuchos::ArrayView<long long>(static_cast<long long*>(farg3->data), farg3->size);
  arg3 = &tmparr3;
  tmparr4 = Teuchos::ArrayView<double>(static_cast<double*>(farg4->data), farg4->size);
  arg4 = &tmparr4;
...
SWIGEXPORT void _wrap_TpetraCrsMatrix_getGlobalRowView(SwigClassWrapper const *farg1, long long const *farg2, SwigClassWrapper const *farg3, SwigClassWrapper const *farg4) {
  Tpetra::CrsMatrix< SC,LO,GO,NO > *arg1 = (Tpetra::CrsMatrix< SC,LO,GO,NO > *) 0 ;
  long long arg2 ;
  Teuchos::ArrayView< long long const > *arg3 = 0 ;
  Teuchos::ArrayView< double const > *arg4 = 0 ;
  ...
  arg1 = smartarg1 ? const_cast< Tpetra::CrsMatrix<SC,LO,GO,NO>* >(smartarg1->get()) : NULL;
  arg2 = static_cast< long long >(*farg2);
  SWIG_check_mutable_nonnull(*farg3, "Teuchos::ArrayView< long long const > &", "SWIGTYPE_Teuchos__ArrayViewT_long_long_const_t", "Tpetra::CrsMatrix< SC,LO,GO,NO >::getGlobalRowView(long long,Teuchos::ArrayView< long long const > &,Teuchos::ArrayView< double const > &) const", return );
  arg3 = static_cast< Teuchos::ArrayView< long long const > * >(farg3->cptr);
  SWIG_check_mutable_nonnull(*farg4, "Teuchos::ArrayView< double const > &", "SWIGTYPE_Teuchos__ArrayViewT_double_const_t", "Tpetra::CrsMatrix< SC,LO,GO,NO >::getGlobalRowView(long long,Teuchos::ArrayView< long long const > &,Teuchos::ArrayView< double const > &) const", return );
  arg4 = static_cast< Teuchos::ArrayView< double const > * >(farg4->cptr);
  {
    // Make sure no unhandled exceptions exist before performing a new action
