...
type, bind(C) :: SwigArrayWrapper
 ...
 type :: RowInfo
  ...
  type(SwigClassWrapper), public :: swigdata
 contains
  procedure :: set_localRow => set_RowInfo_localRow
  procedure :: get_localRow => get_RowInfo_localRow
  procedure :: set_allocSize => set_RowInfo_allocSize
  procedure :: get_allocSize => get_RowInfo_allocSize
  procedure :: set_numEntries => set_RowInfo_numEntries
  procedure :: get_numEntries => get_RowInfo_numEntries
  procedure :: set_offset1D => set_RowInfo_offset1D
  procedure :: get_offset1D => get_RowInfo_offset1D
 ...
 contains
  ...
  procedure :: getGlobalRowindicesView => swigf_TpetraCrsMatrix_getGlobalRowindicesView
  procedure :: getGlobalRowValuesView => swigf_TpetraCrsMatrix_getGlobalRowValuesView
...
function swigc_TpetraCrsGraph_getGlobalRowView(farg1, farg2) &
...
function swigc_TpetraCrsMatrix_getGlobalRowindicesView(farg1, farg2) &
bind(C, name="swigc_TpetraCrsMatrix_getGlobalRowindicesView") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
import :: SwigArrayWrapper
import :: SwigClassWrapper
...
function swigc_TpetraCrsMatrix_getGlobalRowValuesView(farg1, farg2) &
bind(C, name="swigc_TpetraCrsMatrix_getGlobalRowValuesView") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
import :: SwigArrayWrapper
import :: SwigClassWrapper
...
subroutine set_RowInfo_localRow(self, localrow)
use, intrinsic :: ISO_C_BINDING
...
function get_RowInfo_localRow(self) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_SIZE_T) :: swig_result
class(RowInfo), intent(inout) :: self
...
subroutine set_RowInfo_allocSize(self, allocsize)
use, intrinsic :: ISO_C_BINDING
class(RowInfo), intent(inout) :: self
...
function get_RowInfo_allocSize(self) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_SIZE_T) :: swig_result
class(RowInfo), intent(inout) :: self
...
subroutine set_RowInfo_numEntries(self, numentries)
use, intrinsic :: ISO_C_BINDING
class(RowInfo), intent(inout) :: self
...
function get_RowInfo_numEntries(self) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_SIZE_T) :: swig_result
class(RowInfo), intent(inout) :: self
...
subroutine set_RowInfo_offset1D(self, offset1d)
use, intrinsic :: ISO_C_BINDING
class(RowInfo), intent(inout) :: self
...
function get_RowInfo_offset1D(self) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_SIZE_T) :: swig_result
class(RowInfo), intent(inout) :: self
...
function swigf_TpetraCrsGraph_getGlobalRowView(self, gblrow) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_LONG_LONG), dimension(:), pointer :: swig_result
class(TpetraCrsGraph), intent(in) :: self
...
farg1 = self%swigdata
farg2 = gblrow
fresult = swigc_TpetraCrsGraph_getGlobalRowView(farg1, farg2)
...
function swigf_TpetraCrsMatrix_getGlobalRowindicesView(self, globalrow) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
integer(C_LONG_LONG), dimension(:), pointer :: swig_result
class(TpetraCrsMatrix), intent(in) :: self
...
farg1 = self%swigdata
farg2 = globalrow
fresult = swigc_TpetraCrsMatrix_getGlobalRowindicesView(farg1, farg2)

call c_f_pointer(fresult%data, swig_result, [fresult%size])
end function

function swigf_TpetraCrsMatrix_getGlobalRowValuesView(self, globalrow) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
real(C_DOUBLE), dimension(:), pointer :: swig_result
class(TpetraCrsMatrix), intent(in) :: self
...
farg1 = self%swigdata
farg2 = globalrow
fresult = swigc_TpetraCrsMatrix_getGlobalRowValuesView(farg1, farg2)
