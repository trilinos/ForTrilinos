...
type, bind(C) :: SwigArrayWrapper
 ...
 contains
  ...
  procedure :: assign => swigf_VectorInt_assign
  procedure :: view => swigf_VectorInt_view
 ...
 contains
  ...
  procedure :: assign => swigf_VectorDouble_assign
  procedure :: view => swigf_VectorDouble_view
 ...
 contains
  ...
  procedure :: assign => swigf_VectorLongLong_assign
  procedure :: view => swigf_VectorLongLong_view
...
subroutine swigc_VectorInt_assign(farg1, farg2) &
bind(C, name="swigc_VectorInt_assign")
use, intrinsic :: ISO_C_BINDING
import :: SwigClassWrapper
...
function swigc_VectorInt_view(farg1) &
bind(C, name="swigc_VectorInt_view") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
import :: SwigArrayWrapper
import :: SwigClassWrapper
...
subroutine swigc_VectorDouble_assign(farg1, farg2) &
bind(C, name="swigc_VectorDouble_assign")
use, intrinsic :: ISO_C_BINDING
import :: SwigClassWrapper
import :: SwigArrayWrapper
type(SwigClassWrapper) :: farg1
...
function swigc_VectorDouble_view(farg1) &
bind(C, name="swigc_VectorDouble_view") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
import :: SwigArrayWrapper
import :: SwigClassWrapper
...
subroutine swigc_VectorLongLong_assign(farg1, farg2) &
bind(C, name="swigc_VectorLongLong_assign")
use, intrinsic :: ISO_C_BINDING
import :: SwigClassWrapper
import :: SwigArrayWrapper
type(SwigClassWrapper) :: farg1
...
function swigc_VectorLongLong_view(farg1) &
bind(C, name="swigc_VectorLongLong_view") &
result(fresult)
use, intrinsic :: ISO_C_BINDING
import :: SwigArrayWrapper
import :: SwigClassWrapper
...
subroutine swigf_VectorInt_assign(self, data)
use, intrinsic :: ISO_C_BINDING
class(VectorInt), intent(inout) :: self
...
call swigc_VectorInt_assign(farg1, farg2)
end subroutine

function swigf_VectorInt_view(self) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
...
farg1 = self%swigdata
fresult = swigc_VectorInt_view(farg1)
...
subroutine swigf_VectorDouble_assign(self, data)
use, intrinsic :: ISO_C_BINDING
class(VectorDouble), intent(inout) :: self
...
farg2%data = c_loc(farg2_view)
farg2%size = size(data)
call swigc_VectorDouble_assign(farg1, farg2)
end subroutine

function swigf_VectorDouble_view(self) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
...
farg1 = self%swigdata
fresult = swigc_VectorDouble_view(farg1)
call c_f_pointer(fresult%data, swig_result, [fresult%size])
end function
...
subroutine swigf_VectorLongLong_assign(self, data)
use, intrinsic :: ISO_C_BINDING
class(VectorLongLong), intent(inout) :: self
integer(C_LONG_LONG), dimension(:), target :: data
...
farg2%data = c_loc(farg2_view)
farg2%size = size(data)
call swigc_VectorLongLong_assign(farg1, farg2)
end subroutine

function swigf_VectorLongLong_view(self) &
result(swig_result)
use, intrinsic :: ISO_C_BINDING
...
farg1 = self%swigdata
fresult = swigc_VectorLongLong_view(farg1)
call c_f_pointer(fresult%data, swig_result, [fresult%size])
end function
