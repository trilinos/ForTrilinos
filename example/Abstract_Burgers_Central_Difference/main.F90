  ...
  function total(lhs,rhs)
    ...
    select type(rhs)
      class is (periodic_2nd_order)
        ...
        call local_total%f%Update(1._c_double,lhs%f,1._c_double,rhs%f,0._c_double)
   ...
   type(periodic_2nd_order) ,allocatable :: local_difference
    select type(rhs)
      class is (periodic_2nd_order)
        ...
        call local_difference%f%Update(1._c_double,lhs%f,-1._c_double,rhs%f,0._c_double)
